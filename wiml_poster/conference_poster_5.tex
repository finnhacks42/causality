...
\documentclass[b0,landscape,25pt]{sciposter}
...
\includegraphics[width=10cm]{nicta_logo2.jpg} % Logo or a photo of you, adjust its dimensions here
\end{minipage}
\begin{minipage}[b]{0.70\linewidth}
\centering
\veryHuge \color{NavyBlue} \textbf{Causal Inference in Machine Learning} \color{Black}\\ % Title
\Huge\textit{From Prediction to Decision Making: A review}\\[1cm] % Subtitle
...
\centering
{\resizebox{0.6\columnwidth}{!}{\includegraphics{intervention_figure-crop}}}
\end{figure}
...
\label{fig:dsep}
\centering
{\resizebox{0.6\columnwidth}{!}{\includegraphics{dsepfigure-crop}}}
\end{figure}
...
\label{fig:SGS}
\centering
{\resizebox{0.4\columnwidth}{!}{\includegraphics{SGS_figure-crop}}}
\end{figure}
...
\newcommand{\imsize}{.5\columnwidth}

\begin{figure}
\caption{The FCI Algorithm}
\label{fig:FCI}
\centering
{\resizebox{0.9\columnwidth}{!}{\includegraphics{FCI_figure-crop}}}
\end{figure}
...
{\resizebox{\imsize}{!}{\includegraphics{Janzig6}}}
\end{figure}
