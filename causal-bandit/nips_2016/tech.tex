...
The proof of Theorem \ref{thm:uq-simple} requires some lemmas, the first of which is an immediate consequence of the Chernoff bound (see Exercise 2.10 in \cite{boucheron2013concentration} for this form of the Chernoff bound).
