...
\end{figure} 
\todof{connect truncated product formula to here by noting that the truncated formula allows us to estimate $P_a$ from observational quantities - which could plausible be available prior to running the experiment, allowing us to assume the $P_a$'s are known.}
