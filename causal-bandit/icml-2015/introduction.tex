...
However, in \S\ref{sec:simple-regret-general}, Theorem~\ref{thm:general-upper} shows how an importance-sampling based algorithm (Algorithm~\ref{alg:alloc}) can obtain non-trivial guarantees on simple regret.
