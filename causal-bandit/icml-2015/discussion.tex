...
\ref{alg:general} cannot be used. Estimating these quantities will simultaneously minimising the simple regret is an interesting and challenging open problem.
