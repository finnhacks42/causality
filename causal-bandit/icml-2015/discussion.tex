...
\paragraph{Using the Reward Signal}
...
If instead we choose to use other graph feedback models for cumulative regret we would require those with time varying graphs~\citep{Alon2015,Kocak2014}.
