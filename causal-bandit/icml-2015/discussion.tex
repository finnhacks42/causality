...
Another open question is whether cumulative regret bounds can be obtained for the general causal bandit problem we have proposed.
...
Each time an action $do(X_i = j) \in \calA$ is chosen 
