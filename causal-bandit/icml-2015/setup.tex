...
The following game is played over $T$ rounds. 
...
In the farming example from the introduction, $X_1$ represent temperature with $X_1=0$ denoting low and $X_1=1$ high temperature. 
...
In each round of the game, the learner selects a single variable to intervene on and the value to set it to while the remainder of the variables are simultaneously set by independently biased coin flips. 
