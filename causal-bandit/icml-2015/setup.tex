...
This follows from application of the do-calculus \cite{Pearl2000} to the causal graph for the parallel bandits problem (\cref{fig:causalStructure}). It is not the case in general. 
