...
\todom{Reconcile with new def. of m}
...
on all observations over all $T$ rounds and $\EE_i$ the expectation with respect to $\operatorname{P}_i$. By Lemma 2.6 by \cite{Tsy08} we have
\eq{
