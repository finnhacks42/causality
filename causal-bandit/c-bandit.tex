...
\eq{
m_{a,b}    &= \sum_{s=1}^t \ind{I_t = i, J_t = j, X_a = b, Y_t = 1} \\
n_{a,b}    &= \sum_{s=1}^t \ind{I_t = i, J_t = j, X_a = b} \\
...
\eq{
\P{\left|\frac{m_{a,b}}{n_{a,b}} - \mu_{i,j}^{a,b}\right| \geq \sqrt{\frac{1}{2n_{a,b}} \log \frac{2t}{\delta}}} \leq \delta\,.
}
Therefore by the union bound
\eq{
\P{\left|p_a \frac{m_{a,1}}{n_{a,1}} + (1 - p_a) \frac{m_{a,0}}{n_{a,0}} - \mu_{i,j}\right| \geq p_a \sqrt{\frac{1}{2n_{a,1}} \log\frac{4t}{\delta}}
+ (1 - p_a) \sqrt{\frac{1}{2n_{a,0}}\frac{4t}{\delta}}} \leq \delta\,
}
