...
\section{What problems require causal inference?}
...
Asking if these problem require causal inference is somewhat disingenuous as they are not posed in sufficient detail to determine if causality is an important consideration. In particular, I failed to specify how any (machine learning) model we might build would be used, and what actions could be taken in response to its predictions. This is a trivial but significant observation. 
