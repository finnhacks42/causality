...
Causal graphical models are not enough. A causal graph that is correct in the sense that it accurately predicts the outcome of an intervention, does not capture how that intervention could turn out in an alternate world in which implicit bias and discrimination did not exist. As is well understood in economics, we can get a local minima in which individuals and companies are acting rationally (for example by not hiring women) but the consequence for society as a whole is worse.
